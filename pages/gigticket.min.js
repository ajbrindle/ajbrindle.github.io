...
a+"b.jpeg')";document.getElementById("colour3").style.backgroundImage="url('../images/template-thumbs/background"+a+"c.jpeg')";document.getElementById("colour4").style.backgroundImage="url('../images/template-thumbs/background"+a+"d.jpeg')";document.getElementById("price-row").hidden=null===document.getElementById("ticket-price-"+a);document.getElementById("address-row").hidden=null===document.getElementById("ticket-address-"+a);6===currentTemplate&&(document.getElementById("ticket-band-name-6").style.fontFamily=
window.getComputedStyle(document.getElementById("font21")).fontFamily);document.getElementById("promoter-row").hidden=6===currentTemplate;document.getElementById("support-row").hidden=6===currentTemplate;document.getElementById("venue-row").hidden=6===currentTemplate;document.getElementById("show-doors-row").hidden=6===currentTemplate;document.getElementById("type-row").hidden=6===currentTemplate;document.getElementById("font-dropdown").style.display=6===currentTemplate?"none":"block";dispatchEvents();
setOverrideData()}function setOverrideData(a=null,b=null){var c="ticket-promoter- ticket-band-name- ticket-band-other- ticket-date-time- ticket-doors- ticket-venue- ticket-address- ticket-type- ticket-price-".split(" ");for(const d of c)c=document.getElementById(d+currentTemplate),null!==c&&(null===a?null!==c.getAttribute("data-font-size")&&(c.style.fontSize=c.getAttribute("data-font-size")):a.checked&&(c.style.color=b))}
